...
var packageBody,ground, side1, side2, underside;
...
function setup() {
	...
	underside = Bodies.rectangle(400 , 650 , 200 , 20 , {isStatic:true});
  World.add(world,underside);

  	side1 = Bodies.rectangle(300 , 620 , 20 , 100 , {isStatic:true});
